...
public class ApprovalService {
	...
	public Page<ApprovalResponseDto.ApprovalHistoryDto> PendingApprovalList(String loginId, Pageable pageable) {
		...
		return approvalHistoryRepository.findPendingApprovals(userId, pageable)
				.map(ApprovalResponseDto.ApprovalHistoryDto::from);
	}

	// 결재 이력 보관함(PND는 제외)
	public Page<ApprovalResponseDto.ApprovalHistoryDto> listOrSearchApprovalList(String loginId, Long documentType,
		...
		return approvalHistoryRepository.findApprovalList(userId, status, documentType, keyword, pageable)
				.map(ApprovalResponseDto.ApprovalHistoryDto::from);
	}
	...
	public void approveDocument(String loginId, Long documentId, String comment) {
		...
		ApprovalHistory currentHistory = approvalHistoryRepository.findCurrentStepApproval(documentId, approverId)
